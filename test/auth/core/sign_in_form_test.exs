  ...
  describe ".validate_user" do
    test "user not exists" do
      %{valid?: valid?, errors: [email: {error, _}]} =
        Auth.SignInForm.call(%{email: "not_exist@email.com", password: "123456"}, %{repo: TestRepo, schema: TestUser})
    ...
    test "invalid password" do
      with_mocks [
        ...
        %{valid?: valid?, errors: [password: {error, _}]} =
          Auth.SignInForm.call(%{email: "test@email.com", password: "invalid"}, %{repo: TestRepo, schema: TestUser})
    ...
    test "valid" do
      with_mocks [
        ...
        %{valid?: valid?, changes: %{context: context}} =
          Auth.SignInForm.call(%{email: "test@email.com", password: "123qwe"}, %{repo: TestRepo, schema: TestUser})
